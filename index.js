...
async function welcomeAnimation() {
    const startingAnimation = chalkAnimation.neon(boxen(`Student Management System\nProject 07\nBy\nAnas Hakeem`, {
        title: "*My Project*",
...
async function promptUser() {
    const studentInfo = await inquirer.prompt([
        {
            ...
            validate: (value) => value.trim() !== "" || chalk.bgYellow.red("Please enter a valid name."),
        },
        {
            type: "number",
            name: "Age",
            message: chalk.bgWhite.blue(`Enter Student Age : `),
            validate: (value) => (!isNaN(value) && value >= 0 && value <= 150) ||
        ...
        },
        {
            type: "input",
            name: "university",
            message: chalk.bgWhite.black(`Could You Please Give Me The University's Name : `),
            validate: (value) => value.trim() !== "" ||
        ...
        },
        {
            type: "list",
            name: "courses",
            message: chalk.bgRed.white.underline.bold("Please Select one Course or Exit"),
            choices: [
    ...
    for (const [key, value] of Object.entries(studentInfo)) {
        console.log(chalk.red.underline.bold(key) +
            " : " +
            chalk.bgWhite.blueBright.italic(value));
    }
}
promptUser().catch((error) => console.error(chalk.bgRed.white.underline("An error occurred:", error)));
////////////////////////// "Ending Project" /////////////////////////
